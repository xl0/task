...
export const mockMessages: Message[] = [
	{
		...
		summary: 'Wants to lock in Thursday 2pm for due diligence; needs revenue projections by Wednesday.',
	...
	},
	{
		...
		summary: 'Four pre-screened VP Eng candidates. Recommends Candidate A (ex-Stripe) and C (ex-Datadog).',
	...
	},
	{
		...
		summary: 'API migration blocked — payment service dependency issue. Timeline may slip to next Wednesday.',
	...
	},
	{
		...
		summary: 'Reverses earlier request — keep board deck Thursday. Asks to confirm 2pm investor meeting with Sarah.',
	...
	},
	{
		...
		summary: 'Two things: engineering grumbling about hybrid policy; needs benefits package sign-off by Friday.',
	...
	},
	{
		...
		summary: 'FYI only — Q2 marketing plan finalised. New brand campaign, +20% paid spend. No action needed.',
	...
	},
	{
		...
		summary: 'URGENT: Payment service issue hitting 3% of live checkouts. Needs rollback vs hotfix decision within an hour.',
	...
	},
	{
		...
		summary: 'Resolved — Lisa and David aligned on revised 10-week timeline with phased delivery. No action needed.',
	...
	},
	{
		...
		summary: 'Offers to move Thursday to 10am. Needs revenue projections before the call — partners meeting following Monday.',
	...
	},
	{
		...
		summary: 'Northwind deal terms changed by legal — dropped to 1-year/60k ARR. Needs decision by EOD.',
