...
export const mockMessages: Message[] = [
	{
		...
		"read": false,
		"summary": "Sarah wants to schedule Thursday 2pm diligence and receive updated revenue projections by Wednesday."
	},
	{
		"id": "m2",
		"channel": "slack",
		...
		"read": false,
		"summary": "API migration is 60% complete, likely done by Friday, with a possible one-day auth refactor delay."
	},
	{
		"id": "m3",
		"channel": "whatsapp",
		...
		"read": false,
		"summary": "James wants to postpone the board deck review to next week until Q1 finance numbers arrive."
	},
	{
		"id": "m4",
		"channel": "email",
		...
		"read": false,
		"summary": "Urgent suspicious-login alert requests immediate identity verification to prevent account suspension."
	},
	{
		"id": "m5",
		"channel": "slack",
		...
		"read": false,
		"summary": "Horizon demo went well; client wants the next iteration in two weeks with no changes requested."
	},
	{
		"id": "m6",
		"channel": "email",
		...
		"read": false,
		"summary": "David warns Horizon is likely 10-12 weeks, not 6, and urges an internal alignment before the next client call."
	},
	{
		"id": "m7",
		"channel": "whatsapp",
		...
		"read": false,
		"summary": "Mum is asking you to confirm Sunday dinner plans and bring the wine if you can."
	},
	{
		"id": "m8",
		"channel": "email",
		...
		"read": false,
		"summary": "Rachel sent a 4-candidate VP Engineering shortlist and recommends prioritizing Candidates A and C for interviews."
	},
	{
		"id": "m9",
		"channel": "slack",
		...
		"read": false,
		"summary": "API migration is paused due to a payment service dependency issue, possibly delaying completion until next Wednesday."
	},
	{
		"id": "m10",
		"channel": "whatsapp",
		...
		"read": false,
		"summary": "Hold the board deck for Thursday, and confirm the 2pm investor meeting with Sarah from Meridian."
	},
	{
		"id": "m11",
		"channel": "email",
		...
		"read": false,
		"summary": "Weekly AI newsletter highlights regulation, funding, agentic workflows, and AI technical debt trends."
	},
	{
		"id": "m12",
		"channel": "slack",
		...
		"read": false,
		"summary": "Northwind deal closed at 120k ARR for 2 years; need engineering support for April 1 onboarding integration timeline."
	},
	{
		"id": "m13",
		"channel": "whatsapp",
		...
		"read": false,
		"summary": "Alex reports engineering grumbling about the new hybrid policy and needs your sign-off on the benefits package by Friday."
	},
	{
		"id": "m14",
		"channel": "email",
		...
		"read": false,
		"summary": "Q2 marketing plan is finalized: April brand campaign, 20% paid spend increase, and two new channel tests."
	},
	{
		"id": "m15",
		"channel": "email",
		...
		"read": false,
		"summary": "Thursday 2pm leadership sync is confirmed; review Q1, hiring, and Horizon project status."
	},
	{
		"id": "m16",
		"channel": "slack",
		...
		"read": false,
		"summary": "Payment service issue is impacting 3% of live checkouts; decision needed within an hour on rollback versus risky hotfix."
	},
	{
		"id": "m17",
		"channel": "email",
		...
		"read": false,
		"summary": "David and Lisa aligned on a revised 10-week Horizon timeline; no action needed from you."
	},
	{
		"id": "m18",
		"channel": "whatsapp",
		...
		"read": false,
		"summary": "Sarah can move Thursday’s meeting to 10am and wants revenue projections before the call."
	},
	{
		"id": "m19",
		"channel": "slack",
		...
		"read": false,
		"summary": "Northwind wants a 1-year term with renewal, reducing ARR to 60k; need a decision by EOD."
	},
	{
		"id": "m20",
		"channel": "email",
		...
		"read": false,
		"summary": "Laura moved Thursday’s leadership sync to 3pm in the small meeting room due to a boardroom booking."
	}
];
