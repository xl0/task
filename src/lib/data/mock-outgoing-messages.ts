...
export const mockOutgoingMessages: OutgoingMessage[] = [
	{
		...
		body: '@tom.bradley rollback the partial migration now. Post status updates every 30 minutes until checkout failures are back to baseline.\n\nAfter rollback, share a short root-cause summary and a proposed hotfix plan for next sprint.',
	...
	},
	{
		...
		channel: 'slack',
		channelName: '#sales',
		body: '@priya.sharma Accept the 1-year term if legal can include an expansion checkpoint after month six tied to adoption milestones. If they agree, proceed today and send me the final redline before close.',
	...
	},
	{
		...
		parentMessageId: 'm8',
		recipient: 'rachel.kim@techstaffing.io',
